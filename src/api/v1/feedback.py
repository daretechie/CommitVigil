...
async def log_manager_feedback(feedback: CorrectionFeedback):
    ...
    try:
        ...
        logger.info("manager_feedback_logged", intervention_id=feedback.intervention_id, action=feedback.action_taken)
        return {"status": "success", "message": "Feedback integrated into continuous learning loop."}
