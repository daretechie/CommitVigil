...
async def generate_sales_prospect(
    company_name: str, target_role: str, team_size: int, industry: str = "generic"
):
    """
    ...
    return await scout.generate_profile(
        company_name=company_name, target_role=target_role, team_size=team_size, industry=industry
    )
...
async def generate_executive_brief(
    company_name: str, target_role: str, team_size: int, industry: str, currency: str = "USD"
):
    """
