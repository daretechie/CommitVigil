...
class ContextProfile(BaseModel):
    ...
    confidence: float = Field(default=1.0, description="Confidence level of the context sensing (0.0 to 1.0).")
    ...
    key_entities: list[str] = Field(default_factory=list, description="Industry-specific keywords detected")
    dynamic_safety_rules: list[DynamicSafetyRule] = Field(default_factory=list, description="Firewall rules generated for this context")
